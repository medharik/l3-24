...
DROP DATABASE IF EXISTS `dbl3`;
CREATE DATABASE IF NOT EXISTS `dbl3` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `dbl3`;
